...
*/
#ifndef CENYMLFEATURESCALING_H
#define CENYMLFEATURESCALING_H
...
void getMinMaxNormalization(float *, int, int, float *, float *);
void getReverseMinMaxNormalization(float *, int, int, float *, float *);
void getL2Normalization(float *, int, int, float *, float *);
void getReverseL2Normalization(float *, int, int, float *, float *);
void getZscoreNormalization(float *, int, int, int, float *, float *);
void getReverseZscoreNormalization(float *, int, int, float *, float *);
...
*
* @param float *minMax - This argument will contain the pointer to a
...
*						  TWO TIMES "m" 'float' MEMORY SPACES.
*
* @param float *inputMatrix_dot - This argument will contain the
* 								   pointer to a memory allocated
...
*								   SIZE OF "n" TIMES "m" 'float' MEMORY
*								   SPACES.
*
...
*/
void getMinMaxNormalization(float *inputMatrix, int n, int m, float *minMax, float *inputMatrix_dot) {
...
*				 matrix has, with which the output data was obtained.
*
* @param float *minMax - This argument will contain the vector
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void getReverseMinMaxNormalization(float *inputMatrix_dot, int n, int m, float *minMax, float *inputMatrix) {
	...
	float min[m]; // Variable used to store the minimum values identified for the argument pointer variable "inputMatrix".
	float maxMinusMin[m]; // Variable used to store the difference between the maximum and minimum values identified for the argument pointer variable "inputMatrix".
...
*				 matrix has, with which the output data was obtained.
*
* @param float *magnitude - This argument will contain the pointer
...
*							 FUNCTION WITH A SIZE OF "m" 'float'
*							 MEMORY SPACES.
*
* @param float *inputMatrix_dot - This argument will contain the
* 								   pointer to a memory allocated
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void getL2Normalization(float *inputMatrix, int n, int m, float *magnitude, float *inputMatrix_dot) {
...
*							 WITH A SIZE OF "m" 'float' MEMORY SPACES.
*
* @param float *inputMatrix - This argument will contain the
*							   pointer to a memory allocated
*							   matrix in which all the values of the
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void getReverseL2Normalization(float *inputMatrix_dot, int n, int m, float *magnitude, float *inputMatrix) {
...
*								deviation.
*
* @param float *meanAndstdDev - This argument will contain the pointer
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void getZscoreNormalization(float *inputMatrix, int n, int m, int degreesOfFreedom, float *meanAndstdDev, float *inputMatrix_dot) {
...
*								 TIMES "m" 'float' MEMORY SPACES.
*
* @param float *inputMatrix - This argument will contain the pointer to
...
*							   A VARIABLE SIZE OF "m" TIMES "n" 'float'
*							   MEMORY SPACES.
*
* NOTE: RESULT IS STORED IN THE MEMORY ALLOCATED POINTER VARIABLE
*       "inputMatrix".
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void getReverseZscoreNormalization(float *inputMatrix_dot, int n, int m, float *meanAndstdDev, float *inputMatrix) {
