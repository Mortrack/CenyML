...
void getSimpleLinearRegression(float *, float *, int, int, int, float *);
void predictSimpleLinearRegression(float *, float *, int, int, int, float *);
void getMultipleLinearRegression(float *, float *, int, int, int, char, float *);
void predictMultipleLinearRegression(float *, float *, int, int, int, float *);
void getPolynomialRegression(float *, float *, int, int, int, int, char, float *);
void predictPolynomialRegression(float *, int, float *, int, int, int, float *);
void getMultiplePolynomialRegression(float *, float *, int, int, int, int, char, char, float *);
void predictMultiplePolynomialRegression(float *, int, char, float *, int, int, int, float *);
void getLogisticRegression(float *, float *, int, int, int, char, float *);
void predictLogisticRegression(float *, float *, int, int, int, float *);
void getGaussianRegression(float *, float *, int, int, int, char, char, float *);
void predictGaussianRegression(float *, char, float *, int, int, int, float *);
...
*					 WITH A SIZE OF "n" TIMES "m=1" 'float' MEMORY
*					 SPACES.
*
...
*/
void getSimpleLinearRegression(float *X, float *Y, int n, int m, int p, float *b) {
...
*					 SIZE OF "m+1=2" 'float' MEMORY SPACES.
*
* @param int n - This argument will represent the total number of
*				 samples (rows) that the input matrix has, with which 
*				 the output data was obtained.
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void predictSimpleLinearRegression(float *X, float *b, int n, int m, int p, float *Y_hat) {
	// If the machine learning features exceed the value of one, then emit an error message and terminate the program. Otherwise, continue with the program.
	if (m != 1) {
		Serial.print("\nERROR: The machine learning features (independent variables) must be equal to 1 for this particular algorithm.\n");
		exit(1);
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void getMultipleLinearRegression(float *X, float *Y, int n, int m, int p, char isVariableOptimizer, float *b) {
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void predictMultipleLinearRegression(float *X, float *b, int n, int m, int p, float *Y_hat) {
	// If the machine learning features are less than the value of one, then emit an error message and terminate the program. Otherwise, continue with the program.
	if (m < 1) {
		Serial.print("\nERROR: The machine learning features (independent variables) must be equal or greater than 1 for this particular algorithm.\n");
		exit(1);
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void getPolynomialRegression(float *X, float *Y, int n, int m, int p, int N, char isVariableOptimizer, float *b) {
	// If the machine learning features are less than the value of one, then emit an error message and terminate the program. Otherwise, continue with the program.
	if (m != 1) {
		Serial.print("\nERROR: The machine learning features (independent variables) must be equal to 1 for this particular algorithm.\n");
		exit(1);
	...
	float *X_tilde = (float *) malloc(n*NplusOne*sizeof(float)); // This variable will contain the input data of the system under study ("X") and an additional first row with values of "1".
	float *TransposeOf_X_tilde = (float *) malloc(NplusOne*n*sizeof(float)); // We allocate the memory required for the local pointer variable that will contain the input data from which the desired machine learning method will be calcualted.
	int currentRow2; // This variable is used in the for-loop for the matrix transpose that will be made.
	int currentColumn2 = 0; // This variable is used in the for-loop for the matrix transpose that will be made.
	...
	int currentRowTimesN; // This variable is used to store a repetitive multiplication in some for-loops, for performance purposes.
	int currentColumnTimesN; // This variable is used to store a repetitive multiplication in some for-loops, for performance purposes.
	float *matMul1 = (float *) calloc(NplusOne*NplusOne, sizeof(float)); // We allocate, and initialize with zeros, the memory required for the local pointer variable that will contain the result of making a matrix multiplication between "X_tilde" and its transpose.
	...
	//		 inverse matrix that was obtained is stored in
	//		 "TransposeOf_X_tilde".
	float *matMul2 = (float *) calloc(NplusOne*n, sizeof(float)); // We allocate the memory required for the local pointer variable that will contain the result of making a matrix multiplication between the resulting inverse matrix of this process and the transpose of the matrix "X_tilde".
	for (int currentRow=0; currentRow<NplusOne; currentRow++) {
		currentRowTimesN = currentRow*n;
		currentRowTimesNplusOne = currentRow*NplusOne;
		for (int currentColumn=0; currentColumn<n; currentColumn++) {
...
*					 THAT THIS VARIABLE IS ALLOCATED AND INITIALIZED
*					 BEFORE CALLING THIS FUNCTION WITH A VARIABLE
*					 SIZE OF "N+1" TIMES "p=1" 'float' MEMORY SPACES.
*
* @param int n - This argument will represent the total number of
*				 samples (rows) that the input matrix has, with which 
*				 the output data was obtained.
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void predictPolynomialRegression(float *X, int N, float *b, int n, int m, int p, float *Y_hat) {
	// If the machine learning features are less than the value of one, then emit an error message and terminate the program. Otherwise, continue with the program.
	if (m != 1) {
		Serial.print("\nERROR: The machine learning features (independent variables) must be equal to 1 for this particular algorithm.\n");
		exit(1);
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void getMultiplePolynomialRegression(float *X, float *Y, int n, int m, int p, int N, char isInteractionTerms, char isVariableOptimizer, float *b) {
...
*					 THAT THIS VARIABLE IS ALLOCATED AND INITIALIZED
*					 BEFORE CALLING THIS FUNCTION WITH A VARIABLE
*					 SIZE OF "m*N+1" TIMES "p=1" 'float' MEMORY SPACES.
*
* @param int n - This argument will represent the total number of
*				 samples (rows) that the input matrix has, with which 
*				 the output data was obtained.
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void predictMultiplePolynomialRegression(float *X, int N, char isInteractionTerms, float *b, int n, int m, int p, float *Y_hat) {
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void getLogisticRegression(float *X, float *Y, int n, int m, int p, char isVariableOptimizer, float *b) {
	// If the machine learning features are less than the value of one, then emit an error message and terminate the program. Otherwise, continue with the program.
	if (m < 1) {
		Serial.print("\nERROR: The machine learning features (independent variables) must be equal or greater than 1 for this particular algorithm.\n");
		exit(1);
	...
	for (int currentRow=0; currentRow<n; currentRow++) {
		...
		if (Y[currentRow] <= 0) {
			Serial.print("\nERROR: The output data had a value that is equal or less than zero. Please assign the proper output values for this algorithm, considering the restriction: 0 < y_{i,k} < 1.\n");
			exit(1);
		}
		if (Y[currentRow] >= 1) {
			Serial.print("\nERROR: The output data had a value that is equal or greater than one. Please assign the proper output values for this algorithm, considering the restriction: 0 < y_{i,k} < 1.\n");
			exit(1);
		}
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void predictLogisticRegression(float *X, float *b, int n, int m, int p, float *Y_hat) {
	// If the machine learning features are less than the value of one, then emit an error message and terminate the program. Otherwise, continue with the program.
	if (m < 1) {
		Serial.print("\nERROR: The machine learning features (independent variables) must be equal or greater than 1 for this particular algorithm.\n");
		exit(1);
...
*					 "p=1" 'float' MEMORY SPACES. However, the
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void getGaussianRegression(float *X, float *Y, int n, int m, int p, char isForceGaussianCurve, char isVariableOptimizer, float *b) {
	// If the machine learning features are less than the value of one, then emit an error message and terminate the program. Otherwise, continue with the program.
	if (m < 1) {
		Serial.print("\nERROR: The machine learning features (independent variables) must be equal or greater than 1 for this particular algorithm.\n");
		exit(1);
	...
	for (int currentRow=0; currentRow<n; currentRow++) {
		...
		if (Y[currentRow] > 1) {
			Serial.print("\nERROR: The output data had a value that is greater than one. Please assign the proper output values for this algorithm, considering the restriction: 0 < y_{i,k} <= 1.\n");
			exit(1);
		}
...
*					 VARIABLE SIZE OF "m*2+1" TIMES "p=1" 'float'
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void predictGaussianRegression(float *X, char isForceGaussianCurve, float *b, int n, int m, int p, float *Y_hat) {
	// If the machine learning features are less than the value of one, then emit an error message and terminate the program. Otherwise, continue with the program.
	if (m < 1) {
		Serial.print("\nERROR: The machine learning features (independent variables) must be equal or greater than 1 for this particular algorithm.\n");
		exit(1);
