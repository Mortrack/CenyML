...
*					   CALLING THIS FUNCTION WITH A SIZE OF "1" 'DOUBLE'
...
*/
void getCrossEntropyError(double *realOutputMatrix, double *predictedOutputMatrix, int n, double NLLepsilon, double *NLL) {
...
*								   OF "4" TIMES "1" 'DOUBLE' MEMORY SPACES,
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void getConfusionMatrix(double *realOutputMatrix, double *predictedOutputMatrix, int n, double *confusionMatrix) {
	...
	for (int currentRow = 0; currentRow < n; currentRow++) {
		if ((realOutputMatrix[currentRow]==1) && (predictedOutputMatrix[currentRow]==1)) {
			...
			printf("\nERROR: An output value from either the real or the predicted output matrixes contains a non binary value in the row index %d.\n", currentRow);
		}
	}
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void getAccuracy(double *realOutputMatrix, double *predictedOutputMatrix, int n, double *accuracy) {
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void getPrecision(double *realOutputMatrix, double *predictedOutputMatrix, int n, double *precision) {
	...
	double sumOfPredictedOutputMatrix = 0; // Variable used to store the total sum of values contained in the "predictedOutputMatrix".
	for (int currentRow = 0; currentRow < n; currentRow++) {
	...
	if (sumOfPredictedOutputMatrix == 0) {
		printf("ERROR: The total amount of true positives and false positives equals zero. Therefore, the precision cannot be calculated because it gives a mathematical indetermination.\n");
	}
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void getRecall(double *realOutputMatrix, double *predictedOutputMatrix, int n, double *recall) {
	...
	double sumOfRealOutputMatrix = 0; // Variable used to store the total sum of values contained in the "realOutputMatrix".
	for (int currentRow = 0; currentRow < n; currentRow++) {
	...
	if (sumOfRealOutputMatrix == 0) {
		printf("ERROR: The total amount of true positives and false negatives equals zero. Therefore, the recall cannot be calculated because it gives a mathematical indetermination.\n");
	}
...
* LAST UPDATE: DECEMBER 04, 2021
*/
void getF1score(double *realOutputMatrix, double *predictedOutputMatrix, int n, double *F1score) {
	...
	double precision = 0; // Variable used to store the precision with respect to the output data given in "realOutputMatrix" and "predictedOutputMatrix".
	double recall = 0; // Variable used to store the recall with respect to the output data given in "realOutputMatrix" and "predictedOutputMatrix".
	for (int currentRow = 0; currentRow < n; currentRow++) {
	...
	if (recall == 0) {
		printf("ERROR: The total amount of true positives and false negatives equals zero. Therefore, the F1 score cannot be calculated because the recall gives a mathematical indetermination.\n");
	}
	recall = precision / recall;
	if (F1score[0] == 0) {
		printf("ERROR: The total amount of true positives and false positives equals zero. Therefore, the F1 score cannot be calculated because the precision gives a mathematical indetermination.\n");
	}
