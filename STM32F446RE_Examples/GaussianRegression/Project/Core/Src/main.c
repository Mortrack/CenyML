...
int main(void)
{
  ...
  int n = 3070; // This variable will contain the number of samples that the system under study will have.
  ...
  double databaseY[] = {0.028565501, 0.135335283, 0.411112291, 0.800737403, 1, 0.800737403, 0.411112291, 0.135335283, 0.028565501, 0.00386592}; // This variable contains the expected/real output data of the system under study for when n=10.
  ...
  b_ideal[0] = 50; // This is the true b_0 coefficient value with which the database was generated.
  b_ideal[1] = 15*15; // This is the true b_1 coefficient value with which the database was generated.
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  // ------------------ PREPROCESSING OF THE DATA ------------------ //
	  	...
	  	// We validate the getGaussianRegression method.
	  	printf("Initializing coefficients validation of the CenyML getGaussianRegression method ...\n");
	  	startingTime = HAL_GetTick(); // We obtain the reference time to count the elapsed time to validate the getGaussianRegression method.
	  	epsilon = 8.0E-6; // Variable used to store the max error value permitted during validation process.
	  	...
	  	printf("The coefficients validation of the CenyML getGaussianRegression method elapsed %ld milliseconds.\n\n", elapsedTime);
