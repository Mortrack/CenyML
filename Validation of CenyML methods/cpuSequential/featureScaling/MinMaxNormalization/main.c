...
int main(int argc, char **argv) {
	...
	printf("Innitializing CenyML min max normalization method ...\n");
	...
	printf("Innitializing CenyML reverse min max normalization method ...\n");
	...
	printf("Innitializing validation of the CenyML reverse min max normalization method ...\n");
