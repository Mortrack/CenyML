...
int main(int argc, char **argv) {
	...
	char csv1Directory[] = "../../../../Databases/classificationDBs/randPolynomialClassificationSystem/polynomialClassificationSystem_10systems_100samplesPerAxisPerSys.csv"; // Directory of the reference .csv file
