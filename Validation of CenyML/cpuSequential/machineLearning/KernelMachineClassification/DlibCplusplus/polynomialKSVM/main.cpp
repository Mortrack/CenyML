...
#include <stdio.h>
#include <stdlib.h>
#include "../../../../../../CenyML library skeleton/otherLibraries/time/mTime.h" // library to count the time elapsed.
...
int main() {
	...
	char nameOfTheCsvFile2[] = "Dlib_polynomialSVM_evalMetrics.csv"; // Name the .csv file that will store the resulting evaluation metrics for the ML model to be obtained.
    ...
    double gamma = 1/m; // We will define a gamma similarly to how scikit-learn does.
	trainer.set_kernel(kernel_type(gamma));
    trainer.set_c(1); // Define the "C" desired value inside the argument of "trainer.set_c()".
	...
	decision_function<kernel_type> KSVM_model = trainer.train(samples, labels); // We train the linear SVM model.
