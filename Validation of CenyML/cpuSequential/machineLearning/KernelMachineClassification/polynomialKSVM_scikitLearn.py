...
# polynomial Kernel support vector machine classification. This is done with
# the database used for polynomial equation systems. In addition, this
# database has 10'000 samples. Moreover, the well known scikit-learn library
# will be used for such machine learning algorithm (https://bit.ly/3oVImz6).
...
elapsedTime = time.time() - startingTime
print("Polynomial Kernel SVM model training with the scikit-learn library elapsed " + format(elapsedTime) + " seconds.")
print("")
