...
# LAST UPDATE: N/A.
#
# This code is used to apply the machine learning method known as the Sigmoid
# Kernel support vector machine classification. This is done with the database
# used for linear equation systems. In addition, this database has 10'000
...
dataset_lES100S100SPAPS = pd.read_csv("../../../../databases/classification/linearEquationSystem/100systems_10samplesPerAxisPerSys.csv")
...
# ----- Model training ----- #
# -------------------------- #
print("Innitializing Sigmoid Kernel SVM model training with the scikit-learn library ...")
startingTime = time.time()
classifier = SVC(kernel='sigmoid', random_state=0)
classifier.fit(X, Y_ravel)
elapsedTime = time.time() - startingTime
print("Sigmoid Kernel SVM model training with the scikit-learn library elapsed " + format(elapsedTime) + " seconds.")
print("")
