...
The files located in this directory path are all used for the validation and evaluation of the linear logistic classification that was developed in the CenyML library. The following describes the purpose of each program contained in this directory:

- **main.c** creates a linear logistic classification model with the CenyML library to solve a linear classification system.
- **scikitLearn.py** creates a linear logistic classification model with the scikit-learn library to solve a linear classification system.
