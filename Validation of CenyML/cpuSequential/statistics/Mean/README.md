...
The files located in this directory path are all used for the validation and evaluation of the statistic method called mean and that was developed in the CenyML library. The following describes the purpose of each program contained in this directory:

- **main.c** applies the statistic method called mean, with the CenyML library and with respect to the random data of a Multiple polynomial system.
- **NumPy.py** applies the statistic method called mean, with the NumPy library and with respect to the random data of a Multiple polynomial system.
