...
int main(int argc, char **argv) {
	...
	char csv1Directory[] = "../../../../databases/classification/randPolynomialEquationSystem/10systems_100samplesPerAxisPerSys.csv"; // Directory of the reference .csv file
	...
	// ------------------------- DATA MODELING ----------------------- //
	printf("Initializing CenyML Quick Mode method ...\n");
