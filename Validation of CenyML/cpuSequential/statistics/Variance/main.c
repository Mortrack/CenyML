...
int main(int argc, char **argv) {
	...
	// Allocate the memory required for the variable "X", which will contain the input data of the system whose variance will be obtained.
	...
	// ------------------------- DATA MODELING ----------------------- //
	printf("Initializing CenyML variance method calculation ...\n");
