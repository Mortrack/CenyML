...
int main(int argc, char **argv) {
	...
	neuron1.cpuThreads = 65; // This variable will define the number of CPU threads that wants to be used to parallelize the training and predictions made by the neuron to be created.
