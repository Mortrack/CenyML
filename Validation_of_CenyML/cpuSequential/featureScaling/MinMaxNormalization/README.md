...
The files located in this directory path are all used for the validation and evaluation of the feature scaling method called min max normalization and that was developed in the CenyML library. The following describes the purpose of each program contained in this directory:

- **main.c** applies the feature scaling method called min max normalization, with the CenyML library and with respect to the random data of a Multiple polynomial system.
- **scikitLearn.py** applies the feature scaling method called min max normalization, with the scikit-learn library and with respect to the random data of a Multiple polynomial system.
