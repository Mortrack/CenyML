...
* the feature scaling method known as the Z score normalization, will be applied
* to the matrix "X". Then, a reverse method of the previously applied Z score
...
* "CenyML_getZscoreNormalization_Results.csv" will be created and in it, the
* resulting values of applying the Z score normalization method will be saved
...
#include "../../../../CenyML_library_skeleton/CenyML_Library/cpuSequential/featureScaling/CenyMLfeatureScaling.h" // library to use the feature scaling methods of CenyML.
...
* then calculate the Z score normalization of each value. Then, a reverse of the
* Z score normalization method will be applied and validated here with respect to
* the original input data. Finally, the results of the applied Z score
* normalization method will be saved in a new .csv file for further comparation
...
int main(int argc, char **argv) {
	...
	char csv1Directory[] = "../../../../databases/regression/randMultiplePolynomialEquationSystem/100systems_100samplesPerAxisPerSys.csv"; // Directory of the reference .csv file
	char nameOfTheCsvFile[] = "CenyML_getZscoreNormalization_Results.csv"; // Name the .csv file that will store the results.
	...
	// We apply the reverse Z score normalization method for each of the values contained in "x_dot" and the result is stored in the memory location of the pointer "reverse_x_dot".
	getReverseZscoreNormalization(x_dot, n, desired_m, meanAndstdDev, reverse_x_dot);
	elapsedTime = seconds() - startingTime; // We obtain the elapsed time to calculate the reverse of the Z score normalization method.
	...
	elapsedTime = seconds() - startingTime; // We obtain the elapsed time to validate the reverse of the Z score normalization method.
	printf("The validation of the CenyML reverse Z score normalization method elapsed %f seconds.\n\n", elapsedTime);
	
	// We save the results of the applied Z score normalization method.
