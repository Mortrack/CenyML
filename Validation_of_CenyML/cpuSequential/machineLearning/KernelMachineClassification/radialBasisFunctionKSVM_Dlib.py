...
# LAST UPDATE: N/A.
#
# This code is used to apply the machine learning method known as the RBF
# support vector machine classification. This is done with the database used
# for linear equation systems. In addition, this database has 10'000 samples.
# Moreover, the well known Dlib library will be used for such machine learning
# algorithm (http://dlib.net/). Then, some metrics will be obtained, along
# with a plot to use these as a comparative evaluation of the results obtained
# in the CenyML library.
# --------------------------------------------------------------------------- #
# --------------------------------------------------------------------------- #
...
# that uses a radial basis kernel.  If you wanted to use a linear kernel or
# histogram intersection kernel you could change it to one of these lines:
