...
int main(int argc, char **argv) {
	...
	neuron1.w_first[1] = 1; // We define the cuztomized desired value for the weight_1 value of the neuron to be created.
	...
	neuron1.stopAboveThisAccuracy = 0.96; // The value of this variable is used as a stop function for the single neuron in DNN learning proccess.
