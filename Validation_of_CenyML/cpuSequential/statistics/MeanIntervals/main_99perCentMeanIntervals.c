...
* "CenyML_get99perCentMeanIntervals_Results.csv" will be created and in it, the
...
* "99perCentMeanIntervals_ExcelResults". Finally, the obtained mean intervals
...
int main(int argc, char **argv) {
	...
	char csv2Directory[] = "99perCentMeanIntervals_ExcelResults.csv"; // Directory of the reference .csv file that contains the results of Excel that were obtained using its "Data Analysis" tool, for comparative purposes.
	char nameOfTheCsvFile[] = "CenyML_get99perCentMeanIntervals_Results.csv"; // Name the .csv file that will store the results.
	...
	float desiredTrustInterval = 99; // We define the numeric porcentage that is desired for the trust interval to be used to calculate the mean intervals.
	...
	double epsilon = 4.8E-2; // Variable used to store the max error value permitted during validation process.
