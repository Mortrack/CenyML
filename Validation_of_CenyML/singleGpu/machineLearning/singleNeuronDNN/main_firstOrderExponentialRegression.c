...
int main(int argc, char **argv) {
	...
	char nameOfTheCsvFile1[] = "CenyML_firstOrderExponentialRegression_Coefficients.csv"; // Name the .csv file that will store the resulting coefficient values.
	char nameOfTheCsvFile2[] = "CenyML_firstOrderExponentialRegression_EvalMetrics.csv"; // Name the .csv file that will store the resulting evaluation metrics for the ML model to be obtained.
	...
	struct singleNeuronDnnStruct_singleGPU neuron1; // We create a singleNeuronDnnStruct_parallelCPU structure variable to manage the data input and output data of the single neuron in DNN that will be created.
	...
	neuron1.activationFunctionToBeUsed = 9; // This variable tells the neuron what activation function to use (see the commented documentation in the function "getSingleNeuronDNN()" for more details).
	neuron1.learningRate = 0.00000000000001; // This variable stores the desired learning rate for the neuron to be created.
	neuron1.stopAboveThisAccuracy = 0.999; // The value of this variable is used as a stop function for the single neuron in DNN learning proccess.
