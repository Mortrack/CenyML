...
int main(int argc, char **argv) {
	...
	neuron1.maxUnrollingLoop = 1; // This variable will define the desired maximum Unrolling Loop strategy that wants to be applied within the Parallel Reduction and Unrolling Warp strategies (these are applied in the single neuron in DNN algorithm).
