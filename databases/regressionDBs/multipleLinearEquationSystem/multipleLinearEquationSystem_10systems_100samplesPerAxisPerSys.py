...
f = open("multipleLinearEquationSystem_10systems_100samplesPerAxisPerSys.txt","w+") # Create a new file to store data in it.
totalSystemsEvaluated = 10; # This will define the number of systems that will be sampled.
samplesGenPerAxisPerSystem = 100; # This will define the number of samples to generate for each axis of the requested sampled system.
...
for currentSystem in range(1, totalSystemsEvaluated+1):
    ...
    for currentSample1 in range(1, samplesGenPerAxisPerSystem+1):
        ...
        for currentSample2 in range(1, samplesGenPerAxisPerSystem+1):
            ...
            currentIndVarData1 = (10 + 0.4*x1 + 0.4*x2) + currentRandomValue1 # This is the equation that will govern the generated systems.
